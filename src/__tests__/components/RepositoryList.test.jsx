...
const expectRepositoryContent = (item, values) => {
  const wrappedItem = within(item);
  const { name, description, languages, stars, forks, reviews, rating } =
    values;
...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expectRepositoryContent(firstRepositoryItem, {
      ...
      expectRepositoryContent(secondRepositoryItem, {
